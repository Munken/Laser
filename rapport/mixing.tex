...
The Three-wave mixing is a property of the second order nonlinearity of the polarity, $\chi^{(2)}$, dependence on the electric field, $\mathcal{E}(t)$, where two waves couple together to form a third new wave.
