...
The Three-wave mixing is a property of the second order nonlinearity of the polarity dependence of the electric field, $\mathcal{E}(t)$, where two waves couple together to form a third new wave.
Qualitatively the phenomenon can be understood by a simple model. The two waves induces a polarization in the material which's oscilation is a superposition of the two. Pressumed that the material has the right properties, this superimposed oscilating polarization will manifest itself as an electromagnetic wave. 
...
In a simple model the up-conversion can be considered as a multiphoton exitation that emits new light at the sum frequency. The down-conversion as a exitation of the first photon energy and a deexitation (or destructive interference) corresponding to the second photon energy.
...
done in \cite{sumFreq} where a 455 nm is med from a 807 nm and a 1062 source. Though only with an efficienty of $0.01\%$, which is assumed to be due to beam mis-alignment. Efficiency's upto $93.7\%$ has been achieved by DTU Fotonik \cite{DTU}, which they use for optical coherence tomography.
