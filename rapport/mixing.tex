...
\[
\mathbf{\mathbf{E}}(t) = \mathcal{E}_1e^{i(\mathbf{k_1} \cdot \mathbf{r} - \omega_1 t)}+\mathcal{E}_2e^{i(\mathbf{k_2} \cdot \mathbf{r} - \omega_2 t)}.
\]
Inserting this into the second order part of the polarity expansion yields\cite[sec.~21.2C]{saleh}
\begin{align}
