...
% No more than 250 words. Use past tense.
     ...
     In the laser physics course, nonlinear effects have only briefly
     ...
     the polarization. 
     % Fortæl kort hvad effekterne kan bruges til
     % Fortæl om numeriske metoder (og at de fejlede)
     % Opsummering af konklusionen.
     %
     % Max 250 ord i alt.
     %
